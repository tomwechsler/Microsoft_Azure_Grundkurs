...
Get-AzSubscription -SubscriptionName "Kostenlose Testversion" | Select-AzSubscription
Get-AzContext
...
Get-AzResource -ResourceGroupName tw-azuregrundkurs-rg | Format-Table

#Some variables
$RGName = "tw-azuregrundkurs-rg"
